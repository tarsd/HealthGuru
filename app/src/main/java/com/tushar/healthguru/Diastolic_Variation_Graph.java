...
public class Diastolic_Variation_Graph extends Activity implements OnClickListener{
    ...
    TextView title1,title2;
		...
		protected void onCreate(Bundle savedInstanceState) {
			...
			setContentView(R.layout.diastolic);
			title1 = (TextView)findViewById(R.id.tvdiatitle1);
	        Typeface custom_font = Typeface.createFromAsset(getAssets(), "fonts/FunnyKid.ttf");
	        title1.setTypeface(custom_font);
	        title2 = (TextView)findViewById(R.id.tvdiatitle2);
		    ...
		    etnumsystolic = (EditText)findViewById(R.id.etnodiastolic);
			bsystolic = (Button)findViewById(R.id.bnodiastolic);
		...
		public void onClick(View arg0) {
			...
			if(num>=3)
			{
				...
				Intent ourIntent1 = new Intent(Diastolic_Variation_Graph.this,Tempdia.class);
